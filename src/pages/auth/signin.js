    ...
    <>
      ...
      <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#000', color: '#fff', fontFamily: 'system-ui, sans-serif' }}>
        <div style={{ textAlign: 'center', maxWidth: 460, padding: 32 }}>
          ...
          <a href="https://staging.herr.tech/dashboard/ki-toolbox" style={{ display: 'inline-block', padding: '10px 20px', borderRadius: 9999, background: '#B598E2', color: '#000', fontSize: 13, fontWeight: 700 }}>
            Zur Plattform →
          </a>
        </div>
      </main>
